...
/*   Updated: 2024/02/07 18:49:27 by greus-ro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_radixsort_iteration(t_stack **stack_a, t_stack **stack_b, \
			size_t n)
{
	size_t	size;
	size_t	i;
...
static size_t	ft_get_number_of_bits(t_stack *stack)
{
	size_t	num_bits;
	t_stack	*node;
	int		value;
...
void	ft_radixsort(t_stack **stack_a, t_stack **stack_b)
{
	...
	num_bits = ft_get_number_of_bits(*stack_a);
	i = 0;
	while (i < num_bits)
	{
